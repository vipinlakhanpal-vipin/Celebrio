...
export function DashboardClient({
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid grid-cols-3 gap-1.5 sm:gap-3">
        <div
        ...
        >
          ...
          <p className="font-display text-base font-bold text-white sm:text-2xl">{pendingApprovals.length}</p>
          <p className="mt-0.5 text-[8px] font-semibold uppercase tracking-wide text-white/75 sm:mt-1 sm:text-[11px]">
            To approve
          </p>
        </div>
        ...
        >
          ...
          <p className="font-display text-base font-bold text-white sm:text-2xl">{contactCount}</p>
          <p className="mt-0.5 text-[8px] font-semibold uppercase tracking-wide text-white/75 sm:mt-1 sm:text-[11px]">
            Contacts
          </p>
        </div>
